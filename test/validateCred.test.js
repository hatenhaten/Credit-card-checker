...
describe("validateCred", () => {
    test("returns true when passed a valid credit card number", () => {
        ...
        expect(validateCred(valid2)).toBe(true);
        expect(validateCred(valid3)).toBe(true);
        expect(validateCred(valid4)).toBe(true);
        expect(validateCred(valid5)).toBe(true);
    });

    test("returns false when passed a invalid credit card number", () => {
        expect(validateCred(invalid1)).toBe(false);
        expect(validateCred(invalid2)).toBe(false);
